    ...
    <div class="container-fluid dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">Tambah Data Persyaratan Beasiswa</div>
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group row">
                                <label for="nama_persyaratan" class="col-md-8">Nama Persyaratan Beasiswa</label>
                                <div class="col-md-10">
                                    <input type="text" name="nama_persyaratan" required placeholder="Nama Persyaratan Beasiswa" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="keterangan" class="col-md-8">Keterangan</label>

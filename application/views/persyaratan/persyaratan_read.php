    ...
    <div class="container-fluid dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">Data Persyaratan Beasiswa
                        <a href="<?php echo base_url('persyaratan/tambah') ?>" class="btn btn-sm btn-success float-right"><i class="fas fa-plus"></i>Tambah Data</a>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered" id="mytabel">
                            ...
                            <tbody>
                                ...
                                foreach ($persyaratan as $a) {
                                    ...
                                    <td>" . $a->keterangan . "</td>
                                    <td><a href=" . base_url('persyaratan/ubah/' . $a->id) . " class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Ubah</a>
                                                <a href=" . base_url('persyaratan/hapus/' . $a->id) . " onclick='return confirm(\"ingin hapus data ini?\")' class='btn btn-sm btn-danger'><i class='fas fa-trash'></i> Hapus</a>
                                    </td></tr>";
                                }
                                ?>
                            </tbody>
